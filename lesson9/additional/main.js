...
for (const user of usersList) {
    ...
    let userBlockCompany = document.createElement('div');
    userBlockCompany.classList.add('user-block__company');
   ...
   let userWebsite = document.createElement('p');
    ...
    companyTitle.innerText = user.company.name;
    ...
    let catchPhraseList = document.createElement('p');
    catchPhraseList.innerText = user.company.catchPhrase;
    let bs = document.createElement('p');
    bs.innerText = 'bs:';
    let bsList = document.createElement('p');
    bsList.innerText = user.company.bs;
    ...
    companyInfo.append(catchPhrase, catchPhraseList, bs, bsList);
    userBlockCompany.append(companyTitle, companyInfo);
    userBlock.append(userBlockPerson, userBlockCompany);
    usersBox.appendChild(userBlock)
}
